...
public interface OnboardingActivities {
   ...
   */
  @ActivityMethod
  String storeDocuments(ApplicationRequest request);
   ...
   */
  @ActivityMethod
  KycResult performKycCheck(String customerId, String documentId, ApplicationScenario scenario);
   ...
   */
  @ActivityMethod
  String submitToComplianceQueue(String customerId, KycResult kycResult);
   ...
   */
  @ActivityMethod
  void escalateReview(String customerId);
   ...
   */
  @ActivityMethod
  String activateAccount(String idempotencyKey, String customerId, String documentId);
   ...
   */
  @ActivityMethod
  void notifyCustomer(String customerId, String status, String message);
   ...
   */
  @ActivityMethod
  SanctionsResult sanctionsScreening(String customerId, ApplicationScenario scenario);
}
